...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC BY MR BLAXE", "Dekstop", "3.0"]})
console.log(color('[ SC BY MR BLAXE]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : WKWK\n➸ Creator : MR BLAXE\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : DJ PIXEL`\n➸ My Instagram : @djpixel01_\n\nDonase Me For Support :\n➸ DONASI : -\n\nThanks\n', 'red'))
...
if (connection){
if (connection != "connecting") console.log("_Connecting to *jadibot*_..")
}
console.log(up)
if (up.qr) await sendImage(from, await qrcode.toDataURL(up.qr,{scale : 8}), 'Scan QR ini untuk menjadi Bot sementara\n\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \nQR Akan Kadaluarsa dalam 20 detik', m)
...
sendMessage(`6285823360959@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
